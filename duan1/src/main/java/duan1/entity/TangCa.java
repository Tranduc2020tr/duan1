...
public class TangCa {
    ...
    public TangCa(String maTangCa, String maNV, String ngay, int soGio, String checkin, String checkout, String loaiTangCa, double heSo, String trangThai, String ghiChu, String ngayTao, String nguoiTao, String hoten) {
