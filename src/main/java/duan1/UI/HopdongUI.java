...
public class HopdongUI extends javax.swing.JDialog implements hopdongcontroller {
    ...
    public void init() {
        ...
        XTable.styleContractTable(tb1);
        XTable.styleContractTable(tb2);
        ...
        // Cập nhật ngày kết thúc khi chọn lại loại hợp đồng
        cbx_loaihopdong.addActionListener(evt -> calculateContractDates());
        ...
        // Chặn nhập ký tự âm/không phải số cho lương thoả thuận
        try {
            AbstractDocument doc = (AbstractDocument) txt_luongthoathuan.getDocument();
    ...
    private void initComponents() {
        ...
        txt_ngayketthuc.setText("jLabel4");

        txt_ngaybatdau.setText("jLabel4");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_ngayketthuc, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
    ...
    public void them() {
        try {
            if (!validateSalaryAndSelections()) {
                return;
            }
            ...
            // Set ngày tạo (ISO yyyy-MM-dd để lưu DB) và người tạo
            Date currentDate = XDate.now();
            entity.setNgaytao(XDate.format(currentDate, "yyyy-MM-dd"));
    ...
    public Hopdong getform(boolean includeMahd) {
        ...
        // Chuyển đổi ngày từ dd/MM/yyyy sang yyyy-MM-dd cho SQL (định dạng an toàn)
    ...
    private String convertDateToSQLFormat(String dateStr) {
        ...
        try {
            ...
            // Không fallback các định dạng rủi ro; trả về chuỗi rỗng để tránh lỗi SQL
            return "";
        }
        return "";
    }

    private boolean validateSalaryAndSelections() {
        // Kiểm tra loại hợp đồng được chọn
        if (cbx_loaihopdong.getSelectedItem() == null) {
            javax.swing.JOptionPane.showMessageDialog(this, "Vui lòng chọn loại hợp đồng!", "Thông báo", javax.swing.JOptionPane.WARNING_MESSAGE);
            cbx_loaihopdong.requestFocus();
            return false;
        ...
        // Kiểm tra ngày bắt đầu/kết thúc (labels hiện đang hiển thị)
        String start = txt_ngaybatdau.getText();
        String end = txt_ngayketthuc.getText();
        if (start == null || start.trim().isEmpty() || end == null || end.trim().isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Ngày bắt đầu/kết thúc chưa hợp lệ!", "Thông báo", javax.swing.JOptionPane.WARNING_MESSAGE);
            return false;
        }

        // Kiểm tra lương không âm
        String luongStr = txt_luongthoathuan.getText();
        if (luongStr == null || luongStr.trim().isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Vui lòng nhập lương thoả thuận!", "Thông báo", javax.swing.JOptionPane.WARNING_MESSAGE);
            txt_luongthoathuan.requestFocus();
            return false;
        }

        try {
            String cleanAmount = luongStr.replaceAll("[^0-9]", "");
            long value = cleanAmount.isEmpty() ? 0 : Long.parseLong(cleanAmount);
            if (value < 0) {
                javax.swing.JOptionPane.showMessageDialog(this, "Lương không được âm!", "Thông báo", javax.swing.JOptionPane.WARNING_MESSAGE);
                txt_luongthoathuan.requestFocus();
                return false;
            }
        } catch (NumberFormatException ex) {
            javax.swing.JOptionPane.showMessageDialog(this, "Lương không hợp lệ!", "Thông báo", javax.swing.JOptionPane.WARNING_MESSAGE);
            txt_luongthoathuan.requestFocus();
            return false;
        }
    ...
    // Chỉ cho phép ký tự số (0-9). Loại bỏ dấu âm và ký tự khác khi gõ.
    private static class NumericOnlyFilter extends DocumentFilter {
        @Override
            ...
            if (selectedContractType != null) {
                ...
                if (!startDateText.isEmpty()) {
                    try {
                        ...
                        // Nếu không parse được ngày bắt đầu, sử dụng ngày hiện tại và vẫn trừ 1 ngày
                        Date currentDate = XDate.now();
                        Calendar calendar = Calendar.getInstance();
